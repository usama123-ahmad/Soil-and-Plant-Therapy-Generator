...
const PlantReportGenerator: React.FC<PlantReportGeneratorProps> = ({ paddockReports = [], setPaddockReports }) => {
    ...
    try {
      await generateCustomPDF(
        paddockReports.map((paddock, idx) => {
          ...
          console.log('DEBUG: handleGenerateCustomPDF - generalCommentsHtml length:', generalCommentsHtml.length);
          return {
            ...rest,
            ...
            // Pass HTML preview only for Plant reports; PDF generator will gate on reportType
            generalCommentsHtml: generalCommentsHtml
          };
        }),
